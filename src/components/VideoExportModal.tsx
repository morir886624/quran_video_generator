...
#Quran #Shorts #Reels #QuranRecitation #Islam #Muslim #AlQuran #IslamicShorts`;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/85 backdrop-blur-md animate-in fade-in duration-200">
      <div className="relative w-full max-w-2xl bg-[#0F172A] border border-slate-700/90 rounded-3xl shadow-2xl p-5 sm:p-6 flex flex-col max-h-[92vh] overflow-y-auto">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        {exportResult && (
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 p-4 rounded-2xl bg-slate-900/90 border border-slate-800">
              <div className="w-28 aspect-[9/16] rounded-xl overflow-hidden border border-slate-700 shadow-md bg-black flex-shrink-0">
                <video
              ...
              <div className="flex-1 w-full space-y-2.5">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white font-bold text-sm shadow-xl shadow-emerald-950/50 transition-all active:scale-95"
                >
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    onClick={handleDownload}
                    className="flex-1 flex items-center justify-center gap-1.5 py-2.5 px-3 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-semibold border border-slate-700 transition-all"
                  >
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2 pb-1 border-b border-slate-800 text-xs font-bold uppercase tracking-wider text-amber-400">
              ...
              <div className="p-3.5 rounded-2xl bg-slate-900 border border-slate-800 space-y-1.5">
                ...
                <div className="p-2.5 rounded-xl bg-slate-800/80 text-xs text-white font-medium select-text">
                  {youtubeTitle}
                </div>
              </div>
              ...
              <div className="p-3.5 rounded-2xl bg-slate-900 border border-slate-800 space-y-1.5">
                ...
                <div className="p-3 rounded-xl bg-slate-800/80 text-right font-quran text-base sm:text-lg text-amber-200 select-text max-h-28 overflow-y-auto leading-loose">
                  {fullArabicText}
                </div>
              </div>
              ...
              <div className="p-3.5 rounded-2xl bg-slate-900 border border-slate-800 space-y-1.5">
                ...
                <div className="p-3 rounded-xl bg-slate-800/80 text-xs text-slate-200 select-text max-h-28 overflow-y-auto whitespace-pre-line leading-relaxed">
                  {fullTranslationText}
                </div>
              </div>
              ...
              <div className="p-3.5 rounded-2xl bg-slate-900 border border-slate-800 space-y-1.5">
                ...
                <div className="p-3 rounded-xl bg-slate-800/80 text-[11px] text-slate-400 select-text max-h-24 overflow-y-auto whitespace-pre-line font-mono">
                  {youtubeDescription}
                </div>
              </div>
            </div>
            ...
            <div className="pt-2 text-center">
              <button
                onClick={onClose}
                className="px-6 py-2 rounded-full bg-slate-800 hover:bg-slate-700 text-xs font-semibold text-slate-300 transition-colors"
              >
                Close Window
              </button>
            </div>
