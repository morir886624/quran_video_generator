    ...
    <div className="space-y-5">
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center p-3 rounded-xl border text-xs font-semibold transition-all ${
              config.aspectRatio === '9:16'
                ? 'bg-emerald-50 dark:bg-emerald-950/60 border-emerald-500 text-emerald-700 dark:text-emerald-300 shadow-sm ring-1 ring-emerald-500/40'
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  ...
                  {isSelected && (
                    <span className="w-4 h-4 rounded-full bg-emerald-500 flex items-center justify-center text-white shadow">
                      <Check className="w-3 h-3" />
                    </span>
                  )}
                </div>
                <p className="text-[10px] text-slate-300/90 line-clamp-2">
                  {preset.description}
                </p>
              </button>
            );
      ...
      <div>
        ...
        {config.customMediaUrl ? (
          <div className="flex items-center justify-between p-3 rounded-xl bg-slate-50 dark:bg-slate-900 border border-emerald-500/40">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 p-3.5 rounded-xl border border-dashed border-slate-300 dark:border-slate-700 hover:border-emerald-500 bg-slate-50 dark:bg-slate-900/60 hover:bg-slate-100 dark:hover:bg-slate-900 text-xs font-semibold text-slate-700 dark:text-slate-300 transition-all active:scale-[0.99]"
          >
