  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-150">
      <div className="relative w-full max-w-2xl bg-[#0F172A] border border-slate-700/90 rounded-3xl shadow-2xl flex flex-col max-h-[85vh] overflow-hidden">
        ...
        {verseTextArabic && (
          <div className="px-6 py-3 bg-slate-900/90 border-b border-slate-800/80 text-right font-quran text-xl text-amber-200/90">
            {verseTextArabic}
          </div>
        )}
        ...
        <div className="p-6 overflow-y-auto space-y-4">
          {isLoading ? (
            <div className="flex flex-col items-center justify-center py-16 gap-3">
              ...
              <span className="text-xs text-slate-400">Loading Tafsir Ibn Kathir...</span>
            </div>
          ) : (
            <div
              className="prose prose-invert prose-emerald max-w-none text-sm text-slate-300 leading-relaxed font-sans"
