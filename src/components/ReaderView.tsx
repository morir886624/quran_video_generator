...
export const ReaderView: React.FC<ReaderViewProps> = ({
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-3 sm:px-6 py-4 pb-32">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 mb-4 p-3 rounded-2xl bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 shadow-sm transition-colors">
        ...
        <button
          ...
          className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold border transition-all ${
            showWordByWord
              ? 'bg-emerald-50 dark:bg-emerald-950/60 border-emerald-400 dark:border-emerald-500/60 text-emerald-700 dark:text-emerald-300'
              : 'bg-slate-100 dark:bg-slate-800/80 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-400 border-slate-200 dark:border-slate-700/80'
          }`}
        >
      ...
      <div className="mb-6 p-4 rounded-2xl bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-3 shadow-sm dark:shadow-lg transition-colors">
        ...
        <div className="flex items-center gap-2 text-xs">
          <div className="flex items-center gap-1 bg-slate-100 dark:bg-slate-800 px-2.5 py-1.5 rounded-lg border border-slate-200 dark:border-slate-700">
          ...
          return (
            <div
              ...
              className={`group relative rounded-2xl border transition-all duration-200 p-4 sm:p-6 ${
                isSelected
                  ? 'bg-emerald-50/70 dark:bg-slate-900/90 border-emerald-500/60 dark:border-emerald-500/50 shadow-md ring-1 ring-emerald-500/30'
                  : 'bg-white dark:bg-slate-900/50 hover:bg-slate-50 dark:hover:bg-slate-900/80 border-slate-200/90 dark:border-slate-800/80 hover:border-slate-300 dark:hover:border-slate-700 shadow-sm'
              }`}
            >
              {/* Verse Header Row */}
              <div className="flex items-center justify-between mb-4 border-b border-slate-200/80 dark:border-slate-800/60 pb-3">
                {/* Ayah Key Badge */}
                <div className="flex items-center gap-2">
                  <span className="px-2.5 py-1 rounded-full bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700/80 text-xs font-bold text-emerald-700 dark:text-emerald-400">
                    {verse.verse_key}
                  </span>
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-full bg-slate-100 hover:bg-slate-200 text-slate-600 hover:text-slate-900 dark:bg-slate-800/60 dark:hover:bg-slate-700 dark:text-slate-400 dark:hover:text-slate-200 transition-colors"
                    title="Copy Verse"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-2.5 py-1 rounded-full bg-slate-100 hover:bg-slate-200 text-slate-700 dark:bg-slate-800/70 dark:hover:bg-slate-700 text-xs font-medium dark:text-slate-300 transition-colors border border-slate-200 dark:border-transparent"
                  >
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium transition-all ${
                    isSelected
                      ? 'bg-emerald-500/15 dark:bg-emerald-500/20 border border-emerald-500/30 dark:border-emerald-500/40 text-emerald-700 dark:text-emerald-300'
                      : 'bg-slate-100 dark:bg-slate-800/80 hover:bg-slate-200 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 border border-slate-200 dark:border-slate-700/60'
                  }`}
                >
                  {isSelected ? (
                    <>
